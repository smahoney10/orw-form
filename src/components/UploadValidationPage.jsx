...
function parseAttestations(rows) {
  return (rows || []).map((row) => ({
    module: getValue(row, ['module']),
    relatedSystem: getValue(row, ['related system', 'related_system', 'relatedsystem']),
    ...
    applicable: getValue(row, ['applicable', 'applicable yes/no', 'applicable selection']),
